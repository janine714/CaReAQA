        ...
        messages=[
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": f"You are a clinician tasked with interpreting heart sounds findings. Based on the given diagnosis from a doctor, your job is to generate at least {num_qas} question answers (QAs) without mentioning report. The question and answers should focus on diagnosis, such that what condition is present in the audio as these will be used to train an AI model for audio based health diagnostics. Note that questions should be answered using only the condition report and nothing else. Your output should be a JSON list of the following structure: {{'QAs': [{{'question': ..., 'answer': ...}}, {{'question': ..., 'answer': ...}}, ...]}} with keys being only question and answer. Example: Is there a murmur present in the cardiac auscultation findings?, No, there is no murmur present in the cardiac auscultation findings."
                    }
                ]
            },
            {
